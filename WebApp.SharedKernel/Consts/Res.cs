...
namespace WebApp.SharedKernel.Consts
{
    public static partial class Res
    {
        ...
        public const string isConfirmed = nameof(isConfirmed);
        public const string isFavorite = nameof(isFavorite);
        public const string statusCode = nameof(statusCode);
        public const string modelState = nameof(modelState);
        ...
        public const string oPaymentTransaction = nameof(oPaymentTransaction);
        public const string lPaymentTransactions = nameof(lPaymentTransactions);
        ...
        public const string oVersion = nameof(oVersion);
        public const string oVersionForced = nameof(oVersionForced);
        public const string lVersions = nameof(lVersions);

        public const string oUserAuth = nameof(oUserAuth);
        public const string lUsers = nameof(lUsers);
        public const string oUser = nameof(oUser);

        public const string oRole = nameof(oRole);
        public const string lRoles = nameof(lRoles);
        ...
        public const string oSystemSetting = nameof(oSystemSetting);
        public const string lSystemSettings = nameof(lSystemSettings);

        public const string oContactUs = nameof(oContactUs);
        public const string lContactUs = nameof(lContactUs);

        public const string lErrorMessages = nameof(lErrorMessages);
    }
    public static partial class Res
    {
